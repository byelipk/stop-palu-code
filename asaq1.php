...
This is the latest version of an SMS data collection system, developed to support the STOP PALU project which works within the scope of the President's Malaria Initiative in Guinea, and monitors rapid diagnostic tests and arteminisin combination therapy medication stock levels of community health workers. An alert notification system is built into the overall framework, which notifies the appropriate health center if a CHW needs to be re-supplied. 
